...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "10BAIli01".to_string());
        RwLock::new(map)
        };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["10.0.0.245"];
pub const RS_PUB_KEY: &str = "iFCby4Om6Fi4J4sbNeVyRAtYSnoNPOUlGBdxVh+kPOE=";
